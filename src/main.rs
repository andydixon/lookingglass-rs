...
async fn handle_request(request: hyper::Request<hyper::Body>, subcommand: Arc<Subcommand>) -> Result<hyper::Response<hyper::Body>, Infallible> {
    Ok(match request.uri().path() {
        ...
        "/D" => serve_static(include_str!("../static/xtermjs/xterm.js"), "text/javascript"),
        "/style" => serve_static(include_str!("../static/xtermjs/xterm.css"), "text/css"),
        "/i" => serve_static(include_str!("../static/xtermjs/xterm-addon-fit.js"), "text/javascript"),
        "/x" => serve_static(include_str!("../static/xtermjs/xterm-addon-search.js"), "text/javascript"),
        "/o" => serve_static(include_str!("../static/xtermjs/xterm-addon-webgl.js"), "text/javascript"),
        "/n" => serve_static(include_str!("../static/xtermjs/xterm-addon-web-links.js"), "text/javascript"),
        "/core.js" => serve_static(include_str!("../static/core.js"), "text/javascript"),
